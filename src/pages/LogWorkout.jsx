...
const recentWorkouts = [
  {
    ...
    name: 'Push day',
    exercises: [
      { name: 'Bench press', sets: Array.from({ length: 4 }, () => ({ reps: '', weight: '' })) },
      { name: 'Overhead press', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Incline dumbbell press', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Lateral raises', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Tricep pushdown', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
    ]
  },
  {
    id: 2,
    name: 'Pull day',
    exercises: [
      { name: 'Deadlift', sets: Array.from({ length: 4 }, () => ({ reps: '', weight: '' })) },
      { name: 'Pull ups', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Barbell row', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Face pulls', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Barbell curl', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
    ]
  },
  {
    id: 3,
    name: 'Leg day',
    exercises: [
      { name: 'Squat', sets: Array.from({ length: 4 }, () => ({ reps: '', weight: '' })) },
      { name: 'Romanian deadlift', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Leg press', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Leg curl', sets: Array.from({ length: 3 }, () => ({ reps: '', weight: '' })) },
      { name: 'Calf raises', sets: Array.from({ length: 4 }, () => ({ reps: '', weight: '' })) },
    ]
  },
]
